...
if __name__ == "__main__":
    ...
    # test_image = os.path.join(image_data_dir, "222_uncrop", "bfi-895.png")
    # test_output = os.path.join(image_data_dir, "222_cropped", "bfi-895_cropped.png")
    ...
    input_dir = os.path.join(image_data_dir, "244_transparent")
    output_dir = os.path.join(image_data_dir, "all_244"+"cropped")
